/*******************************************************************************
  ...
  *  Ejemplo 'RotacionDePantalla' para Tarjetas UNO, NANO y Pro Mini con ATmega328 a 16MHz.
  *  Abstract: Ejemplo identico a 'Hola Mundo' sólo que cambiamos el parámetro 'rotation'
  *  en el método 'new Arduino_GC9A01' de un 0 a un 2.
...
Arduino_GFX *gfx = new Arduino_GC9A01(bus, 7 /* RST */, 2 /* rotation */, true /* IPS */);
